...
variables <- set(
  ...
  estacion = fuzzy_partition(varnames = c(invierno = 1, primavera = 4, verano = 8, otoño = 12),
                              sd = 1.0),
  dur_regadio = fuzzy_partition(varnames = c(nada = 0, poco = 10, medio = 20, bastante = 25,
...
Prueba_01 <- fuzzy_inference(modelo, list(humedad_suelo = 9, temperatura = 10))
...
# Prueba N° 02
Prueba_02 <- fuzzy_inference(modelo, list(humedad_suelo = 50, temperatura = 20))
